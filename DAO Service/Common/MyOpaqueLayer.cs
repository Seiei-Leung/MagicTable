    ...
    public class MyOpaqueLayer : System.Windows.Forms.Control
    {
        ...
        public MyOpaqueLayer(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                Image img = Image.FromStream(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Common.Resources.loading.gif"));
                pictureBox_Loading.Image = ((System.Drawing.Bitmap)img);
